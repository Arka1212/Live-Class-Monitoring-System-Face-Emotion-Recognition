...
json_file = open(r'C:\Users\sayan\Desktop\Face_emotion_detection\CNN_model_B.json')
loaded_model_json = json_file.read()
json_file.close()
classifier = model_from_json(loaded_model_json)

# load weights into new model
classifier.load_weights(r"C:\Users\sayan\Desktop\Face_emotion_detection\CNN_model_B.h5")

#load face
try:
    face_cascade = cv2.CascadeClassifier(r'C:\Users\sayan\Desktop\Face_emotion_detection\haarcascade_frontalface_default.xml')
except Exception:
...
def main():
    ...
    st.sidebar.markdown(
        """ Developed by Sayan Bandopadhyay    
            Email : sayan.banerjee10035@gmail.com""")
